...
<nav
    class="flex items-center justify-between flex-wrap bg-white py-3 lg:px-12 shadow border-solid border-t-4 border-yellow-600">
    <div
        ...
        <div class="flex items-center flex-shrink-0 text-gray-800 mr-16">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <img height="65" width="200"
                    src="https://www.evertecinc.com/wp-content/uploads/2020/07/logo-evertec.png" alt="Evertec">
            </div>
        ...
        <div class="menu w-full lg:block flex-grow lg:flex lg:items-center lg:w-auto lg:px-3 px-8">
            <a href="#responsive-header"
                ...
                <svg viewBox="0 0 651 192" fill="none" xmlns="http://www.w3.org/2000/svg"
                    class="h-16 w-auto text-gray-700 sm:h-12">
...
<div
    ...
    <a class="hover:text-gray-700 text-yellow-600" href="#">
    ...
    <a class="flex items-center hover:text-gray-700 text-yellow-600" href="#">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <span class="flex absolute -mt-5 ml-4">
            <span class="animate-ping absolute inline-flex h-3 w-3 rounded-full bg-gray-600 opacity-75"></span>
    ...
    @if (Route::has('login'))
        <div class="hidden fixed top-0 right-0 px-6 py-6 sm:block">
            @auth
                <a href="{{ url('/dashboard') }}" class="hover:text-gray-700 text-sm text-yellow-600">Dashboard</a>
            @else
                <a href="{{ route('login') }}" class="hover:text-gray-700 text-md text-yellow-600">Login</a>

                @if (Route::has('register'))
                    <a href="{{ route('register') }}"
                        class="ml-4 hover:text-gray-700 text-md text-yellow-600">Register</a>
                @endif
            @endauth
        </div>
    @endif
    <div class="flex grid grid-cols-3 gap-4max-w-4xl mx-auto sm:px-6 lg:px-8 mt-4">
        @foreach ($products as $product)
            <div class="flex flex-row justify-center pt-5 sm:justify-start sm:pt-0">
                        ...
                        <div
                            ...
                            <div class="overflow-hidden relative">
                                ...
                                <div class="flex justify-center">
                                    <div
                                        class="absolute bottom-4 transition duration-500 ease-in-out opacity-0 group-hover:opacity-100">
                                        <a href="cart.html"
                                            class="bg-gray-700 px-3 py-3 hover:bg-red-500 transition duration-300 ease-in-out">
                                            <i
                                                class="fas fa-shopping-cart transition duration-300 ease-in-out flex justify-center items-center text-gray-100"></i>
                                        </a>
                                        <a href="random.html"
                                            class="bg-gray-700 px-3 py-3 hover:bg-red-500 transition duration-300 ease-in-out">
                                            <i
                                                class="fas fa-random transition duration-300 ease-in-out flex justify-center items-center text-gray-100"></i>
                                        </a>
                                        <a href="single_prod.html"
                                            class="bg-gray-700 px-3 py-3 hover:bg-red-500 transition duration-300 ease-in-out">
                                            <i
                                                class="fas fa-search transition duration-300 ease-in-out flex justify-center items-center text-gray-100"></i>
                                        </a>
                                        <a href="cart.html"
                                            class="bg-gray-700 px-3 py-3 hover:bg-red-500 transition duration-300 ease-in-out">
                                            <i
                                                class="fas fa-heart transition duration-300 ease-in-out flex justify-center items-center text-gray-100"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="px-4 py-3 bg-white">
                                ...
                                <div class="flex py-2">
                                    <p class="mr-2 text-xs text-gray-600"> ${{ $product->value }}</p>
                                    <p class="mr-2 text-xs text-red-600 line-through">$15.00</p>
                                    <button class="bg-yellow-600 hover:opacity-100 text-white 0 hover:text-gray-900 rounded-full px-12 py-2 font-semibold"><a href="{{ route('orders.index', $product->id )}}"><i class="mdi mdi-cart -ml-2 mr-2"></i>COMPRAR</a></button>
                                </div>
                                <div class="flex">
                                    <div class="mx-7">
...
<div class="">
    <footer class="text-gray-600 body-font bg-yellow-600">
